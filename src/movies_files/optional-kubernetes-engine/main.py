...
app = moviesshelf.create_app(config, debug=True)


# Make the queue available at the top-level, this allows you to run
# `psqworker main.moviess_queue`. We have to use the app's context because
...
with app.app_context():
    moviess_queue = moviesshelf.tasks.get_moviess_queue()
